      ...
      {data.map((slide: DataType, index: number) => {
        return (
          <div
            ...
            <Typography variant="h5" className="mbe-0.5 text-balance">
              User Analytics
            </Typography>
            <Typography variant="body2" className="mbe-3 text-balance">
            ...
            <Grid container spacing={4} className="relative">
              <Grid item xs={12} sm={8} className="order-2 sm:order-1">
                <div className="flex flex-col gap-4 sm:plb-6">
                  <Typography className="font-medium">{slide.title}</Typography>
                          ...
                          <Grid item key={index} xs={6}>
                            <div className="flex items-center gap-0.5">
                              <CustomAvatar
                                color="primary"
                                variant="rounded"
                                className="font-medium mie-2 bs-[30px] is-12">
                                {slide.details[key]}
                              </CustomAvatar>
...
const UsersSlider = () => {
  ...
  const ResizePlugin: KeenSliderPlugin = (slider: any) => {
